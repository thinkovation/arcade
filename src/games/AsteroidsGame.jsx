      ...
      controls={
        <div className="flex items-center gap-8">
          <div className="grid gap-1" style={{ gridTemplateColumns: "repeat(3,2.5rem)", gridTemplateRows: "repeat(2,2.5rem)" }}>
            <div />
            <Button iconOnly variant="outline" className="size-10 rounded-md border-zinc-600 bg-zinc-800 hover:bg-zinc-700 text-white select-none" {...thrustBp} title="Thrust">▲</Button>
            <div />
            <Button iconOnly variant="outline" className="size-10 rounded-md border-zinc-600 bg-zinc-800 hover:bg-zinc-700 text-white select-none" {...leftBp} title="Rotate Left">↺</Button>
            <div />
            <Button iconOnly variant="outline" className="size-10 rounded-md border-zinc-600 bg-zinc-800 hover:bg-zinc-700 text-white select-none" {...rightBp} title="Rotate Right">↻</Button>
          </div>
